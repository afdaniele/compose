...
<style type="text/css">
    footer#footer {
        height: <?php echo $BOTTOMBAR_HEIGHT ?>px;
        color: #c3c3c3;
        position: absolute;
        bottom: 0;
        left: 0;
...
function footer_user_menu() {
            ...
            <ul class="dropdown-menu dropup" role="menu"
                ...
                <li role="presentation" style="margin-bottom:20px">
                    <a role="menuitem" tabindex="-1" href="#"
                       ...
                       style="color:#ffc864" onMouseOver="this.style.color='#000'"
                       onMouseOut="this.style.color='#ffc864'">
                        <span class="glyphicon glyphicon-log-out" aria-hidden="true"></span> &nbsp;Log
                        out
                    </a>
                </li>
            </ul>
    ...
    <div style="float:left">
        <p style="margin:0; font-size:16px; margin-top:8px">
