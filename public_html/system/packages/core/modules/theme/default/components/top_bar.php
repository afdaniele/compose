...
foreach ($buttons as &$button) {
    if (!$login_enabled && $button['id'] == 'login') {
        continue;
    }
    if (!is_null($pages_whitelist) && !in_array($button['id'], $pages_whitelist)) {
        continue;
    }
    if (!is_null($pages_blacklist) && in_array($button['id'], $pages_blacklist)) {
        continue;
    }
                    ...
                    <tr>
                        ...
                        <td style="vertical-align:top">
                            <h3 style="margin:0 0 0 15px">
                                &nbsp;<?php echo Core::getSetting('navbar_title') ?></h3>
                        </td>
                    </tr>
                </table>
            </a>
