...
<div style="margin: 10px 20px">
    <form id="step-form">
        <p>
            ...
            <a href="https://developers.google.com/identity/protocols/OAuth2WebServer#enable-apis"
               target="_blank">
                this page
            </a> to enable <strong>Google Sign-In</strong>.<br/><br/>

            Once you have your <strong>Client ID</strong>, insert it in the area below and click
            <strong>Next</strong>.
        </p>
