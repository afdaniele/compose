		...
		<ul class="nav navbar-nav">
			...
			<li class="dropup">
				...
				<ul class="dropdown-menu dropup" role="menu" style="background-color:#3c3c3c; color:white">
					...
					<li class="divider"></li>
					<li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo \system\classes\Configuration::$BASE ?>duckiebots" style="color:white" onMouseOver="this.style.color='#000'" onMouseOut="this.style.color='#FFF'"><i class="fa fa-car" aria-hidden="true"></i> &nbsp;Duckiebots</a></li>
