	...
	<div class="container login">
		<div class="row" style="width:480px; margin:auto">
			<div class="center span4 well">
				...
				<p class="text-right">
					<button class="btn btn-primary" type="button" style="width:100%" onclick="administratorLogIn('<?php echo \system\classes\Configuration::$BASE_URL ?>', '<?php echo \system\classes\Configuration::$WEBAPI_VERSION ?>', '<?php echo $_SESSION['TOKEN'] ?>', 'login-form');"><span class="glyphicon glyphicon-chevron-down" aria-hidden="true"></span> &nbsp;Sign in</button>
				</p>
...
<script type="text/javascript">
	$('#login-form #password').keyup(function(e){
		if(e.keyCode == 13){
			// enter key pressed
			administratorLogIn('<?php echo \system\classes\Configuration::$BASE_URL ?>', '<?php echo \system\classes\Configuration::$WEBAPI_VERSION ?>', '<?php echo $_SESSION['TOKEN'] ?>', 'login-form');
		}
	});
</script>
