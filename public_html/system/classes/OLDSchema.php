...
class OLDSchema {
    ...
    /**
     * Parses a schema and returns the corresponding Schema object.
     *
     * @access public
     * @param $schema array The input schema.
     ...
     * @return Schema   Schema from the given path, an empty schema is returned if the subschema does not exist.
     */
